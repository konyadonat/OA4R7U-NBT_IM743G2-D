...
<form action="" method="POST" accept-charset="UTF-8">
        <div class="form-group">
            <label for="kiadoid">Kiadó azonosítója: </label>
            <input class="form-control" type="text" name="kiadoid" required="required" id="kiadoid" /> <br/>
        </div>
        <div class="form-group">
            <label for="iroid">Író azonosítója: </label>
            <input class="form-control" type="text" name="iroid" required="required" id="iroid" /> <br/>
        </div>
        <div class="form-group">
            <label for="konyvtarid">Könyvtár azonosítója: </label>
            <input type="text" class="form-control" name="konyvtarid" required="required" id="konyvtarid" /> <br/>
        </div>
        <div class="form-group">
